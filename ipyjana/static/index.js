...
var HelloModel = widgets.DOMWidgetModel.extend({
    defaults: _.extend(widgets.DOMWidgetModel.prototype.defaults(), {
        ...
        _model_module : 'ipyjana',
        _view_module : 'ipyjana',
...
var HelloView = widgets.DOMWidgetView.extend({
    ...
    createButton: function(el) {
        ...
        input.type = "button";
        input.className = "btn"; // set the CSS class
        let self = this;
        input.addEventListener("click", function () {
            self.model.set('value', "Raaaaaa");
...
module.exports = {"name":"ipyjana","version":"0.1.3","description":"Jana widget","author":"Dmitry Romanov","main":"lib/index.js","repository":{"type":"git","url":"https://github.com/epic/ipyjana.git"},"keywords":["jupyter","widgets","ipython","ipywidgets","jupyterlab-extension"],"files":["lib/**/*.js","dist/*.js"],"scripts":{"clean":"rimraf dist/","prepublish":"webpack","build":"webpack","watch":"webpack --watch --mode=development","test":"echo \"Error: no test specified\" && exit 1"},"devDependencies":{"webpack":"^3.5.5","rimraf":"^2.6.1"},"dependencies":{"@jupyter-widgets/base":"^2.0.1","lodash":"^4.17.4"},"jupyterlab":{"extension":"lib/labplugin"}}
